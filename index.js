const acters = document.querySelector(".title__button");

acters.addEventListener("click", getUrl);

function getUrl() {
    return fetch("https://hp-api.onrender.com/api/characters");
}

const ROOT_CHARACTERS = document.getElementById('card-allCharacters');
    ...
    hover( fullinfo, name) {
     ...
     render() {
        ...
        CHARACTERS.forEach(({ name, alternateNames, house, dateOfBirth, img}) => {
            ...
            <div class="hover" onmouseover="allCharacters.hover(this, '${name}')" onmouseout="allCharacters.hoverOut(this, '${name}')"></div>
            </li>
            `;
        ...
        ROOT_CHARACTERS.innerHTML = html;
